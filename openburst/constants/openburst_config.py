...
#---- set python version
PYTHON_VERSION = os.environ.get("PYTHON_VERSION", "python3.10")

# directory where KML files are saved on the machine of the geoplot server
KML_FILE_PATH = os.environ.get("KML_FILE_PATH", "/KML_FILES")

# postgresql DB parameters
BURST_DB_NAME = os.environ.get("BURST_DB_NAME", "red")
BURST_DB_SERVER_IP = os.environ.get("BURST_DB_SERVER_IP", "172.20.10.5")
...
DEM_SERVER_PORT = int(os.environ.get("DEM_SERVER_PORT", "9978"))  # ws://ip:9978/dem
RAD_SERVER_PORT = int(os.environ.get("RAD_SERVER_PORT", "3333"))  # octave active radar equation computation port  ws://ip:9978/rad
PET_SERVER_PORT = int(os.environ.get("PET_SERVER_PORT", "7824"))  # pet computations
GEOPLOT_SERVER_PORT = os.environ.get("GEOPLOT_SERVER_PORT", "9943")  # geoplot server port  ws://ip:9943/geoplot
DB_SERVER_PORT = os.environ.get("DB_SERVER_PORT", "7234")  # here a server will work to read and write to DB
SENSOR_CONTROL_SERVER_PORT = os.environ.get("SENSOR_CONTROL_SERVER_PORT", "7982")  # a server to control sensors
DETECTION_SIM_SERVER_PORT = os.environ.get("DETECTION_SIM_SERVER_PORT", "7983")  # a server to simulate detections
REBOUND_SERVER_PORT = os.environ.get("REBOUND_SERVER_PORT", "7112")  # a server for notify/listen clients on the DB
